<?php include('header.php'); ?>
	<div class="full-section">
		<div class="portal-wrap portal-intro group">
			<div id="3" class="two-third first">
				<div class="gray-box spacing">
					<h3>
						SESSION 3: Managing Emotional Mayhem
					</h3>
				</div>
				<div class="fitvids">
					<iframe src="https://player.vimeo.com/video/178692140" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				</div>
			</div>
			<div class="third gray-box">
				<ul class="sidebar-list">
					...
					<hr />
					<li>
						<a href="/_i/Quick Start Guide - Coaching.pdf" download>
				...
				<ul class="sidebar-list">
					...
					<hr />
					<li>
						<a href="/portal/session-four.php#4">
